...
async function getItems() {
    let response = await fetch("/operaciones_mcgreen/equipo/mostrarItems");
            ...
            str_items += `
                <tr>
                    ...
                    <td style="display: flex; justify-content: center;">
                        <a data-title="Ver características" href="/operaciones_mcgreen/equipo/info_item/${element[0]}" class="btn btn-see-charac">
...
function createItem (cod_item, name_item, quantity_item) {
    fetch("/operaciones_mcgreen/equipo/registrarItem", {
        method: 'POST',
        headers: {
...
function modifyItem () {
    fetch("/operaciones_mcgreen/equipo/modificarItem", {
        method: 'POST',
        mode: 'same-origin',
        headers: {
            'Accept': 'application/json',
...
function searchItem (item_id) {
    fetch("/operaciones_mcgreen/equipo/buscarItem", {
        method: 'POST',
        headers: {
            'Accept': 'application/json',
            'X-Requested-With': 'XMLHttpRequest',
...
function deleteItem (msg, item_id) {
    let url_fetch = msg == "Encontrados" || msg == "Encontrado" ? "/operaciones_mcgreen/equipo/eliminarItemCompleto" : "/operaciones_mcgreen/equipo/eliminarItem";
