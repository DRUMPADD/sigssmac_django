...
async function getActivities() {
    let response = await fetch("/operaciones_mcgreen/actividades/mostrarActividad");
...
function modifyActivity() {
    fetch("/operaciones_mcgreen/actividades/modificarActividad", {
        method: 'POST',
        headers: {
            'Accept': 'application/json',
            'X-Requested-With': 'XMLHttpRequest',
...
function searchActivity(id_act) {
    fetch("/operaciones_mcgreen/actividades/buscarActividad", {
        method: 'POST',
        headers: {
            'Accept': 'application/json',
            'X-Requested-With': 'XMLHttpRequest',
...
function deleteActivity(msg, act_cod) {
    let url_fetch = msg == "Encontrado" ? "/operaciones_mcgreen/actividades/eliminarActividadCompleto" : "/operaciones_mcgreen/actividades/eliminarActividad"; 
