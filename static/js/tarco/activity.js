...
async function getActivities() {
    let response = await fetch("tarco/operaciones_tarco/actividades/mostrarActividad");
...
function createActivity () {
    fetch("tarco/operaciones_tarco/actividades/crear_actividad", {
        method: 'POST',
        headers: {
...
function modifyActivity() {
    fetch("tarco/operaciones_tarco/actividades/modificarActividad", {
        method: 'POST',
        headers: {
            'Accept': 'application/json',
            'X-Requested-With': 'XMLHttpRequest',
...
function searchActivity(id_act) {
    fetch("tarco/operaciones_tarco/actividades/buscarActividad", {
        method: 'POST',
        headers: {
            'Accept': 'application/json',
            'X-Requested-With': 'XMLHttpRequest',
...
function deleteActivity(msg, act_cod) {
    let url_fetch = msg == "Encontrado" ? "tarco/operaciones_tarco/actividades/eliminarActividadCompleto" : "tarco/operaciones_tarco/actividades/eliminarActividad"; 
